...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EXLM,   SE_AT, KC_HASH,  KC_DLR, KC_PERC,                       KC_CIRC, KC_AMPR, SE_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
  _______,  KC_EQL, KC_MINS, KC_PLUS, SE_LCBR, SE_RCBR, _______,       _______, SE_LBRC, SE_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______,
